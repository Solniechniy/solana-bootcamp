...
import { OfferItem } from '@/components/offer-item.tsx';
    ...
    return (
        <Card>
            <CardHeader>
                ...
                <CardDescription>View and take available offers from other users.</CardDescription>
            </CardHeader>
            <CardContent>
                <div className="space-y-4">
                    ...
                    {paginatedOpenOffers?.length === 0 && (
                        <div className="text-center py-8 text-muted-foreground">No open offers available</div>
                    )}
                </div>
            </CardContent>
