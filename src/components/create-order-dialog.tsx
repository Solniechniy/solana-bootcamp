...
export function CreateOrderDialog({
  ...
  const [formData, setFormData] = useState({
    ...
    tokenB: "GdHsojisNu8RH92k4JzF1ULzutZgfg8WRL5cHkoW2HCK",
    amountA: "0",
    amountB: "0",
  });
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setFormData({
        tokenA:
          METADATA["9NCKufE7BQrTXTang2WjXjBe2vdrfKArRMq2Nwmn4o8S"].address,
        tokenB:
          METADATA["GdHsojisNu8RH92k4JzF1ULzutZgfg8WRL5cHkoW2HCK"].address,
        amountA: "",
        amountB: "",
      });
      setIsOpen(false);
